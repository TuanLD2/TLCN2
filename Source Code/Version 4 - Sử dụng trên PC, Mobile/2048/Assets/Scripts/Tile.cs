...
public class Tile : MonoBehaviour {
	...
	public void PlayApperAnimation()
	{
		anim.SetTrigger ("Appear");
	}

	void ApplyStyleFromHolder(int index) //class TileStyleHoler ThCh index for every Tile. index[0,11]
	{
		if (PlayerPrefs.GetInt ("mode") == 1) 
		{
			...
			TileImage.sprite = TileStyleHolder.Instance.TileStyles [index].bacgroundSprite;
	}
